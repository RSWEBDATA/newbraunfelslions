		...
		<div class="container content">
			<div class="row sHide">
				<div class="col-md-12">
					...
					<object data="newsletters/201903.pdf" type="application/pdf" class="objScroll" width="95%" height="900px" style="border-bottom: #484c4f solid 2px">alt : <a href="newsletters/201903.pdf">Latest Newsletter</a> </object>
				</div>
			</div>
			<div class="row">
				<div class="col-md-12">
